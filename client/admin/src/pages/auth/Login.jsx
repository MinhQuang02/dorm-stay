  ...
  return (
    ...
    >
      <div className="w-full max-w-md mx-auto">
        <h1 className="text-[32px] font-bold text-[#1a1f2c] mb-1">Admin Sign in</h1>
        <p className="text-[14px] text-gray-500 mb-6">
          Admin portal access.{' '}
          <Link to="/signup" className="text-[#d47435] font-medium hover:underline">Request access</Link>
        </p>
